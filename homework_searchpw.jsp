...
<head>
    ...
    <link rel="stylesheet" href="homework/searchuser/searchpw.css" type="text/css">
</head>
<body>
    <header>
            ...
            <article id="search-user-container">
                ...
                <form name="searchform">
                    <div id="left-user-container">
                        ...
                        <input class="input-data" type="text" placeholder="아이디를 입력해주세요" maxlength="13" name="userdata">
                    </div>
                    ...
                    <div id="select-btn">
                        <button type="button" onclick="pwSearchEvent()">확인</button> 
    ...
    <script>
        function pwSearchEvent() {
            console.log("왜안돼?")
            var pwSearchForm = document.searchform
            if (pwSearchForm.userdata.value.length == 0) {
                alert("아이디를 입력해주세요")
                return;
            }
            else if (pwSearchForm.phone.value.length != 11) {
                alert("핸드폰번호를 정확하게 입력해주세요")
                return;
            } 
            pwSearchForm.action = "homework_resultpw.jsp"
            pwSearchForm.submit()
        }
